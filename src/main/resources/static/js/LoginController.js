...
/* Montar json de um objeto */
function montarJson(valor) {
...
function consumirApi(usuario) {
	var request = new XMLHttpRequest();
	var result;
	var endPoint = "https://api-gp.herokuapp.com/usuario/validarEntrada/" + usuario.login + "/" + md5(usuario.senha).toLowerCase();
...
function enviarParaController(usuario) {
	var url = "";
	var json = encodeURI(montarJson(usuario));
	url = "/logar/" + json;
	window.location.replace(url);
}

btnLogar.onclick = iniciar;
